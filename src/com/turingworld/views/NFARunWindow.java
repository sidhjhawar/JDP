...
public class NFARunWindow extends JFrame implements NFABuildViewInterface {
	...
	//	Color myNewBlue = new Color(136, 69, 19);
		...
		testField.setBounds(25, 621, 161, 27);
		actionPanel.add(testField);
		testPanel = new JPanel();
		testPanel.setBounds(519, 621, 309, 33);
		actionPanel.add(testPanel);
		...
		testBtn4 = new JButton("");
		testPanel.add(testBtn4);
		testPanel.setVisible(false);
		arrowLabel = new JLabel("");
		arrowLabel.setIcon(new ImageIcon("image/arrow.png"));
		arrowLabel.setBounds(525, 586, 30, 30);
		actionPanel.add(arrowLabel);
		arrowLabel.setVisible(false);
		
		testBtn = new JButton("Test");
		testBtn.setBounds(201, 623, 89, 23);
		testBtn.addMouseListener(new MouseAdapter(){
			...
			public void mouseClicked(MouseEvent e) {
			 ...
			 testBtn2.setText(" "+testString.charAt(1));
			 testBtn3.setText(" "+testString.charAt(2));
			 testBtn4.setText(" "+testString.charAt(3));
		...
		testPanel.setBackground(new Color(195,195,195));
